import { CanvasController, ICanvasDrawData, ICanvasPrepData } from "@frontend/canvas";
import { createAnnotations, store } from "@redux/exports";
import { v4 as uuidv4 } from 'uuid';
import { EEditorMode, ELabelType, IDatabasePoint, Vector2 } from "@types";
import { watchMouseMovement } from "@frontend/utils";
...
export default class AnnotationDrawerController extends CanvasController<CanvasRenderingContext2D> {
    ...
    pushToRedux(){
        const sampleId = this.store.app.sampleIds[this.store.app.sampleIndex]

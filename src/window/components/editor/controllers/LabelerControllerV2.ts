...
//     constructor(owner: LabelerControllerV2, annotation: IDatabaseAnnotation, drawerIdx: number) {
//         this.owner = owner;
...
// export default class LabelerControllerV2 extends CanvasController<CanvasRenderingContext2D> {
